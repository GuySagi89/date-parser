// $ANTLR 3.5.2 com\\af\\dateparser\\generated\\TreeRewrite.g 2021-10-06 07:49:23
		...
		try {
			...
			switch (alt1) {
				case 1 :
					...
					// AST REWRITE
					// elements: INT, dow, DAY_OF_WEEK, DIRECTION, SEEK_BY, SEEK
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 2 :
					...
					// AST REWRITE
					// elements: DIRECTION, SEEK_BY, INT, dow, DAY_OF_MONTH, SEEK
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 3 :
					...
					// AST REWRITE
					// elements: dow, INT, SEEK, SEEK_BY, MONTH_OF_YEAR, DIRECTION
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 4 :
					...
					// AST REWRITE
					// elements: SEEK, amount, dow, DIRECTION, SEEK_BY, MONTH_OF_YEAR
				...
				case 5 :
					...
					// AST REWRITE
					// elements: SEEK_BY, DIRECTION, SEEK, amt, span
				...
				case 6 :
					...
					// AST REWRITE
					// elements: RELATIVE_DATE, seekby, DAY_OF_WEEK, SEEK, day, EXPLICIT_SEEK, YEAR_OF, month, dir, MONTH_OF_YEAR, dow, year, EXPLICIT_SEEK, amount
